...
:page-title: PRA Quality Standards
:keywords: pra, guide, standards, quality
...
** Transversal PRA: 1+ for Candidate, 3+ (multi-domain) for Approved
* Real named projects
...
. *Quality Standards* (you are here)
. /guides/06-contributing[Contributing a PRA]
...
* *Previous*: /guides/04-lifecycle[Lifecycle]
* *Next*: /guides/06-contributing[Contributing a PRA]
