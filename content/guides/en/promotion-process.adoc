...
:keywords: pra, guide, promotion, domain, bank-wide

*This represents Flow 1* of the three PRA creation flows described in link:governance.adoc[Governance]. This is the organic, bottom-up flow where Domain PRAs are identified as having multi-domain value and promoted to Bank-Wide status.
