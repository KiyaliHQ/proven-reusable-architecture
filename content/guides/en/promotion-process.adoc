= Promotion Process (Domain -> Transversal)
:page-title: Promotion Process
:keywords: pra, guide, promotion, domain, transversal

*This represents Flow 1* of the three PRA creation flows described in link:governance.adoc[Governance]. This is the organic, bottom-up flow where Domain PRAs are identified as having multi-domain value and promoted to Transversal status.

This document describes the process for promoting a Domain pattern to the Transversal level, making it applicable across all organizational domains.

== Overview

The promotion of a Domain pattern to the Transversal level follows a 4-phase process:
...
rectangle "Phase 1: Proposal" as A
rectangle "Phase 2: Review" as B
...
. *Approved* -- Proceeds to Phase 3 (Migration)
. *Revisions required* -- Returns to domain with feedback
. *Rejected* -- Remains Domain-level with justification
...
. *Remove domain-specific aspects*
...
* *3+ domains* adopt the pattern within 6 months (to reach Transversal Approved)
...
No. If a Transversal pattern becomes obsolete, it transitions to `deprecated`, but does not return to Domain level.
...
. *Promotion Process* (you are here)
...
* *Previous*: link:contributing.adoc[Contributing a PRA]
* *Next*: link:governance.adoc[Governance]
