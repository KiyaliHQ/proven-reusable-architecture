...
* Transversal: `pra/transversal/[category]/`
...
* Transversal: Recommended for all domains
...
=== Transversal PRA: From Candidate to Approved
...
* Transversal: Reach 3 multi-domain implementations for Approved
...
=== For a Transversal PRA Candidate
...
=== For a Transversal PRA Approved
