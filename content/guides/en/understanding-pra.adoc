...
rectangle "Transversal PRA" as A
...
rectangle "Can be promoted to Transversal" as E
A --> B
B --> C
B --> D
B --> E
...
* Can be promoted to Transversal if reusable outside the domain (*"in promotion"* status)
* Location: `pra/secteurs/[domain]/[category]/`

*Examples*:

* Functional: Digital Onboarding (Retail), SAP ERP Integration (Corporate)
* Technical: Serverless AWS, file transfer, data pipelines (in absence of Transversal pattern)

NOTE: When a Domain PRA is proposed to become Transversal, it receives the *"in promotion"* status in its metadata. This status is visible to all domains during the review period by the Expert Architects Committee.
...
start
:I have a need;
if (Transversal PRA exists?) then (Yes)
