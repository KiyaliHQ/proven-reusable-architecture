...
:page-title: Roles and Responsibilities
:keywords: pra, guide, roles, responsibilities
...
rectangle "Domain Governance Committees" as GOV_DOM #60a5fa
rectangle "Expert Architects Governance Committee" as GOV_BW #8b5cf6
rectangle "Initiative Team" as INIT
rectangle "Contributing Architects" as ARCH
rectangle "PRA Maintainers" as MAIN
rectangle "PRA Users" as USERS
...
==== 3. Identify Transversal Candidates

* Identify domain PRAs reusable outside the domain
* Propose Domain -> Transversal promotions
...
* Adapt Transversal standards to domain context
...
** Transversal candidate identification (10 min)
...
==== 1. Review Transversal PRAs

* Evaluate Transversal standard PRAs (Flow 2: cross-cutting teams)
* Evaluate Domain -> Transversal promotions (Flow 1)
* Manage Bootstrap: identify and validate priorities (Flow 3)
* *Timeline*: Review within 2 weeks

==== 2. Approve Transversal PRAs

*For Transversal PRAs Approved*:
...
* *Typical agenda*:
** Review Transversal PRAs (Flow 2) (30 min)
** Review Domain -> Transversal promotions (Flow 1) (30 min)
...
| Submit Transversal PRA | I | C | I | *R* | I | I
| Review Transversal PRA | I | *R/A* | C | C | I | I
| Approve Transversal PRA | I | *A* | I | I | C | I
...
| Deprecate Transversal PRA | C | *A* | C | C | R | C
...
* *Members*: See link:/guides/08-governance[Governance Page]
...
. *Roles and Responsibilities* (you are here)
...
* *Previous*: link:/guides/02-understanding-pra[Understanding PRAs]
* *Next*: link:/guides/04-lifecycle[Lifecycle]
