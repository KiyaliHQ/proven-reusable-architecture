...
:page-title: Standards de Qualité PRA
:keywords: pra, guide, standards, qualité
...
** PRA Transversale : 1+ pour Candidate, 3+ (multi-domaine) pour Approved
...
* *Documentation Template* : link to template
...
. *Standards de Qualité* (vous êtes ici)
. /guides/06-contributing[Contribuer un PRA]
...
* *Précédent* : /guides/04-lifecycle[Cycle de Vie]
* *Suivant* : /guides/06-contributing[Contribuer un PRA]
