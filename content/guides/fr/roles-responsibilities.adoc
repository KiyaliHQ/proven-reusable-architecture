...
:page-title: Rôles et Responsabilités
:keywords: pra, guide, roles, responsabilités
...
rectangle "Comités Gouvernance Domaine" as GOV_DOM #60a5fa
rectangle "Comité Gouvernance Architectes Experts" as GOV_BW #8b5cf6
rectangle "Équipe Initiative" as INIT
rectangle "Architectes Contributeurs" as ARCH
rectangle "Mainteneurs PRA" as MAIN
rectangle "Utilisateurs PRA" as USERS
...
==== 3. Identification Candidats Transversale

* Identifier PRA domaine réutilisables hors du domaine
* Proposer promotions Domaine -> Transversale
...
* Adapter standards Transversale au contexte domaine
...
** Identification candidats Transversale (10 min)
...
* *Durée* : 1h30 maximum
* *Agenda type* :
** Review PRAs Transversale (Flow 2) (30 min)
** Review promotions Domaine -> Transversale (Flow 1) (30 min)
...
| Soumettre PRA Transversale | I | C | I | *R* | I | I
| Review PRA Transversale | I | *R/A* | C | C | I | I
| Approuver PRA Transversale | I | *A* | I | I | C | I
...
| Déprécier PRA Transversale | C | *A* | C | C | R | C
...
* *Membres* : Voir link:/guides/08-governance[Page Gouvernance]
...
. *Rôles et Responsabilités* (vous êtes ici)
...
* *Précédent* : link:/guides/02-understanding-pra[Comprendre les PRA]
* *Suivant* : link:/guides/04-lifecycle[Cycle de Vie]
