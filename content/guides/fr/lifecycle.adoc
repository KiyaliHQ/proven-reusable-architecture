...
* Transversale : `pra/transversal/[category]/`
...
* Transversale : Recommandé pour tous les domaines
...
=== PRA Transversale : De Candidate à Approved
...
. Validation critères Transversale (3+ proven-in-use requis)
...
* Transversale : Atteindre 3 implémentations multi-domaines pour Approved
...
=== Pour un PRA Transversale Candidate
...
=== Pour un PRA Transversale Approved
